...
from analysis.scoring import (
    Eligibility, MIN_GAMES, Observation, as_trade, brier, build_report, cluster,
    compare, conditional_scores, decay_series, log_loss, realized_return,
)
...
class ReportTest(unittest.TestCase):
    ...
    def test_go_criteria_include_return_and_coverage(self):
        report = build_report(noisy(n=400), Coverage())
        names = [name for name, _, _ in report.go_criteria()]
        self.assertIn("positive net return on the declared subset", names)
